...
@section('admin_content')
  <div class="bg-white rounded-lg shadow-md overflow-hidden">
    <div class="px-6 py-4 flex items-center justify-between border-b border-gray-100">
      ...
      <a href="/admin/grocery/categories/create" class="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-primary text-white font-semibold hover:bg-red-600">
          ...
          <tbody class="divide-y divide-gray-100 bg-white">
            ...
            <tr class="hover:bg-gray-50">
              ...
              <td class="px-4 py-3 text-right">
                <a href="/admin/grocery/categories/{{ $category->id }}/edit" class="inline-flex items-center gap-2 px-3 py-1.5 bg-primary text-white rounded-md hover:bg-red-600">
                ...
                <form action="/admin/grocery/categories/{{ $category->id }}" method="POST" class="inline" onsubmit="return confirm('Delete category?')">
                  @csrf
                  @method('DELETE')
